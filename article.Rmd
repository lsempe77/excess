...
knitr::opts_chunk$set(echo = FALSE, warning = F,
  ...
  cache = F,fig.width = 7,fig.height = 5, 
  digits = 1, OutDec = ",")
...
Secondly, we compute the population attributable fraction[@Steenland2006] based on the relative risk $\text{RR}$ from parameter $\beta_1$, as follows:
