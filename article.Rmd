...
- Enrique Acosta ^[Max Planck Institute for Demographich Research]
...
exineidep.q<-tateti6.t%>%group_by(Departamento) %>%   
   summarise(`Total excess (TE)`=sum(excess.total.mean,na.rm = T),
     ...
     `Excess Covid-19`=round(sum(complete.covid)),0) %>%
    adorn_totals()
