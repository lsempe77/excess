...
To estimate the first term, excess registered deaths, we fit quasiPoisson regressions to weekly deaths since 2017 by age-groups and region, as follows:
...
We find that `r dif`` shows `r dif.n` deaths per 1000 in comparison to INEI's projections for 2020, which suggests INEI's overestimations of mortality rates. ***This affects our estimation of completeness.***
